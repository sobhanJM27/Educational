                    ...
                    <li
                        ...
                        className={cn('mb-4', {
                            ...
                            'mb-8 flex-[20%] max-w-[20%] yellowTop:max-w-[25%] yellowTop:flex-[25%] navbar:flex-[33%] navbar:max-w-[33%] hero:flex-[50%] hero:max-w-[50%] books:flex-[100%] books:max-w-[100%]':
                                type === 'book',
                            'flex-[49%] max-w-[49%] navbar:flex-[100%] navbar:max-w-[100%]': type === 'article',
                        })}>
                        {type === 'book' ? (
                            <Card theme={cardType as 'black' | 'white'} type={type} details={item as Book} />
                        ) : type === 'course' ? (
                            <Card theme={cardType as 'black' | 'white'} type={type} details={item as Course} />
                        ) : (
                            <Card theme={cardType as 'black' | 'white'} type={type} details={item as Article} />
                        )}
                    </li>
                );
            })}
