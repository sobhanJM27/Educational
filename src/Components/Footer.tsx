        ...
        <div className="flex flex-col gap-4 flex-1 tips:flex-[45%] hero:flex-[100%]">
          ...
          <div className="flex flex-col gap-2 ">
            ...
            <p className="text-sm">
              ...
              مفید صابر زارعی، مهارت‌های زندگی خود را در هر موقعیتی بهبود
              بخشید و زندگی موفق‌تری داشته باشید. دوره‌های آموزشی آکادمی فن
              بیان صابر زارعی به صورت حضوری، آنلاین و آفلاین برگزار می‌شوند.
              برای کسب اطلاعات بیشتر و ثبت‌نام، همین حالا با ما تماس بگیرید.
            </p>
