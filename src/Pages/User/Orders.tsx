...
import { getPurchasedBook, getPurchasedInPerson, getPurchasedOffline, getPurchasedOnline } from '../../api/getters/userAPI';
                    ...
                    return (
                        <TableRow key={idx}>
                            ...
                            <TableCell className='text-center' key='3'>
                                {usePersianNums(moment(item?.date).format('jYYYY/jMM/jDD HH:mm:ss'))}
                            </TableCell>
